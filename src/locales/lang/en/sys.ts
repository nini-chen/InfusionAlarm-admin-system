export default {
  api: {
    ...
    errMsg606: 'The platform permission has expired！',
  },
  app: {
    logoutTip: 'Reminder',
  ...
  exception: {
    ...
    backHome: 'Back Home',
    pageTab403: "You don't have access",
    pageTab404: 'The page you visited does not exist',
    pageTab500: 'Server is reporting an error',
  ...
  login: {
    ...
    accountError: 'error username, Please try again',
    passwordError: 'error passwords, Please try again',
